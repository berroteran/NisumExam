package com.nisum.exam.nisum23.controller;

import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.result.MockMvcResultHandlers.print;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;

import com.nisum.exam.nisum23.dto.UserRequest;
import com.nisum.exam.nisum23.persistence.Phone;
import com.nisum.exam.nisum23.support.utils.StringUtils;
...
class UserControllerTest {
  ...
  void createUser_returnDTO_and_statusOK() throws Exception {
    UserRequest validUser = getValidUserRequestDummy();
  ...
  void createUser_fail_and_messageError() throws Exception {
    UserRequest invalidUser = getInvalidUserRequestDummy();
  ...
  private UserRequest getInvalidUserRequestDummy() {
  ...
  private UserRequest getValidUserRequestDummy() {
    UserRequest ur = new UserRequest();
